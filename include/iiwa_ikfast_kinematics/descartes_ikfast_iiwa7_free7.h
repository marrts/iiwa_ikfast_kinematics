...
{
public:
  iiwa7Kinematics(const std::vector<descartes_light::IKFastFreeDofSampleParams>& free_params,
    ...
    : descartes_light::IKFastKinematics<FloatType>(free_params, world_to_robot_base, tool0_to_tip, is_valid_fn, redundant_sol_fn)
  {
  }
};

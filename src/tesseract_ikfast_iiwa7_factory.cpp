...
#include <iiwa_ikfast_kinematics/tesseract_ikfast_iiwa7_factory.h>
#include <iiwa_ikfast_kinematics/tesseract_ikfast_iiwa7.h>

namespace iiwa_ikfast_kinematics
{
tesseract_kinematics::InverseKinematics::UPtr iiwa7InvKinFactory::create(const std::string& solver_name,
...
TESSERACT_ADD_PLUGIN(iiwa_ikfast_kinematics::iiwa7InvKinFactory, iiwa7InvKinFactory);
